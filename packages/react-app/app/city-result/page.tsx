...
const cityData: CitiesData = {
  seoul: {
    ...
    impacts: {
      ...
      description: "Increasing extreme weather events and urban heat island effect",
      riskAreas: [
  ...
  bangkok: {
    ...
    impacts: {
      main: "Projected Impacts by 2050:",
      description: "Severe flooding risks due to land subsidence and sea level rise",
      riskAreas: [
  ...
  shanghai: {
    ...
    impacts: {
      main: "Projected Impacts by 2050:",
      description: "Without adaptation measures, significant parts of Shanghai could face regular flooding",
      riskAreas: [
        "Pudong district",
      ...
      economicRisk: {
        title: "2. Economic Risk:",
        description: "Shanghai is one of the world's most economically exposed cities to sea level rise",
        infrastructure: [
  ...
  mexicoCity: {
    ...
    impacts: {
      main: "Projected Impacts by 2050:",
      description: "Severe water scarcity and flooding risks due to extreme weather patterns",
      riskAreas: [
      ...
      economicRisk: {
        title: "2. Economic Risk:",
        description: "Mexico City faces dual threats from water scarcity and flood damage",
        infrastructure: [
  ...
  seattle: {
    ...
    impacts: {
      main: "Projected Impacts by 2050:",
      description: "Rising sea levels combined with increased rainfall and storm surge risks",
      riskAreas: [
      ...
      economicRisk: {
        title: "2. Economic Risk:",
        description: "Seattle's maritime economy and coastal infrastructure face significant risks",
        infrastructure: [
  ...
  mumbai: {
    title: "Mumbai by 2050",
    impacts: {
      main: "Projected Impacts by 2050:",
      description: "Critical vulnerability to sea level rise combined with monsoon flooding and extreme heat",
      riskAreas: [
        "Coastal areas including Marine Drive and Worli",
        "Low-lying slum communities including Dharavi",
        "Reclaimed areas in South Mumbai",
        "Flood-prone suburbs near Mithi River"
      ],
      economicRisk: {
        title: "2. Economic Risk:",
        description: "Mumbai faces severe risks to its status as India's financial capital",
        infrastructure: [
          "Financial district in Nariman Point and BKC",
          "Mumbai suburban railway network",
          "Mumbai Port Trust facilities",
          "Informal settlements housing essential workforce"
        ]
      }
    }
  }
...
const CityResult: React.FC<CityResultProps> = ({ selectedCity, onNavigate, onBack }) => {
  ...
  return (
    <>
      ...
      <div className="bg-blue-400 text-white p-6 rounded-lg w-3/4">
        <h3 className="text-xl font-bold mb-4">{cityData[selectedCity].title}</h3>
        ...
        <div className="space-y-4">
          ...
          <div>
            <p className="font-semibold mb-2">{cityData[selectedCity].impacts.economicRisk.title}</p>
            {cityData[selectedCity].impacts.economicRisk.description && (
              <p className="mb-2">{cityData[selectedCity].impacts.economicRisk.description}</p>
            )}
            <p className="font-semibold mb-2">Critical infrastructure at risk includes:</p>
            <ul className="list-disc pl-6">
              {cityData[selectedCity].impacts.economicRisk.infrastructure.map((item, index) => (
